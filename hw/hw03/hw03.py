...
def count_coins(change):
    ...
    def func(n, m):
        ...
        if m == None:
            return 0
        return func(n - m, m) + func(n, get_next_coin(m))
...
def move_stack(n, start, end):
    ...
    "*** YOUR CODE HERE ***"
    def last_dist(start, end):
        return 6 - start - end
    if n > 1:
        move_stack(n-1, start, last_dist(start, end))
        move_stack(1, start, end)
        move_stack(n-1, last_dist(start, end), end)
    elif n == 1:
